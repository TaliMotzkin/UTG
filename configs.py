...
def get_args():
    ...
    parser.add_argument('--nat_drop_out', type=float, default=0.1, help='dropout probability for all dropout layers')
    ...
    parser.add_argument('--replace_prob', type=float, default=0.7, help='probability for storing new neighbors to N-cache replacing old ones')
